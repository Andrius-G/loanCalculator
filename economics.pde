...
public class economics extends PApplet
{
  ...
  class Plot extends StaticUIComponent /////////////////////// #Plot //////////////////////////
  {
    ...
    @Override void setW(int W)
    {
      super.setW(W);
      updateAxisLabels();
      updateDensity();
    }
    @Override void setH(int H)
    {
      super.setH(H);
      updateAxisLabels();
      updateDensity();
    ...
    void setAxisPrecision(int xp, int yp)
    {
      xAxisPrecision=xp;
      yAxisPrecision=yp;
      updateDensity();
    }
    void setAxisLabels(String xText, String yText)
    {
      hasAxisLabels=true;
    ...
    void updateDensity()
    {
      ...
      {
        Point p1=new Point(int(x+(stepX*((float)i))),y+H-(xAxisStep.height/8),xAxisStep); //scaled 4x and we want half height hence xAxisStep.height/8
      ...
      {
        Point p1=new Point(x-(yAxisStep.width/8),int((y+H)-(stepY*((float)i))),yAxisStep);
    ...
    void addData(float px, float py)
    {
  ...
  class AnnuityPlot extends Plot /////////////////////// #Annuity //////////////////////////
  {
    ...
    void setLoanData(int len, float pay, float rate, int LBound, int RBound, boolean doDelay, int LDelay, int RDelay)
    {
      this.L = new Loan();
      if(doDelay)
      {
    ...
    void updatePlotSettings(float A)
    {
      if(L!=null)
      {
  ...
  class LinearPlot extends Plot /////////////////////// #Linear //////////////////////////
  {
    ...
    void updatePlotSettings(float ts, float len)
    {
      if(L!=null)
      {
